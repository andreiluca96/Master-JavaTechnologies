...
public class CompulsoryCourse extends Course {
    ...
    public CompulsoryCourse(int id, String name, String shortName, int year, int semester, String url, Lecturer lecturer, int studyGroupsCount, List<Grade> grade, Package aPackage, CoursePreference targetCoursePreference, List<CoursePreference> preferredCourse, List<StudentPreference> preferredStudentCourse) {
